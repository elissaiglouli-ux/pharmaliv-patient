  ...
  return (
    <main style={{ fontFamily: "'Inter', sans-serif", overflowX: 'hidden' }}>
        ...
        <div style={{
          ...
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
            <svg width="38" height="38" viewBox="0 0 42 42" fill="none">
              <defs>
                <linearGradient id="g1" x1="21" y1="2" x2="21" y2="40" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#4DCFCF"/><stop offset="1" stopColor="#0D8080"/>
                </linearGradient>
                <linearGradient id="g2" x1="2" y1="21" x2="40" y2="21" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#3DC4C4"/><stop offset="1" stopColor="#1B8C8C"/>
                </linearGradient>
              </defs>
          ...
          <Link href="/ordonnance" style={{
            display: 'flex', alignItems: 'center', gap: 6,
            background: '#1B8C8C', color: 'white', padding: '9px 18px',
      ...
      <section style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: '100vh', paddingTop: 70 }}>
        ...
        {/* GAUCHE */}
        <div style={{
          background: 'linear-gradient(160deg,#C2EBEB 0%,#DCF5F5 28%,#EDF9F9 55%,#F6FDFD 78%,#FFFFFF 100%)',
          display: 'flex', flexDirection: 'column', justifyContent: 'center',
          padding: '64px 52px 80px'
        }}>
          <h1 style={{
            fontSize: 'clamp(36px,3.8vw,55px)', fontWeight: 900,
            color: '#0D2D3D', lineHeight: 1.07, letterSpacing: '-0.03em', marginBottom: 22
          }}>
            Vos médicaments<br/>
            livrés à domicile<br/>
            en moins d'une<br/>
            heure<span style={{ color: '#1B8C8C' }}>*</span>
          </h1>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 13, maxWidth: 330 }}>
            <Link href="/ordonnance" style={{
              ...
              background: '#0D2D3D', color: 'white', padding: '15px 24px',
              borderRadius: 12, fontSize: 15, fontWeight: 600, textDecoration: 'none'
            }}>
              Télécharger mon ordonnance
            </Link>
            <Link href="/parapharmacie" style={{
              display: 'flex', alignItems: 'center', gap: 8, justifyContent: 'center',
              background: 'transparent', color: '#0D2D3D', padding: '14px 24px',
              borderRadius: 12, border: '1.5px solid rgba(13,45,61,0.2)',
            ...
            {[
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 11 }}>
                <div style={{
                  ...
                  border: '1.5px solid rgba(27,140,140,0.2)',
          ...
          <p style={{ marginTop: 28, fontSize: 12, color: '#8AABAB', fontStyle: 'italic' }}>
            *Délai indicatif selon disponibilité et localisation.
          </p>
        </div>
        ...
        <div style={{ position: 'relative', overflow: 'hidden', background: '#0D2D3D' }}>
          <img
            src="https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=900&q=80&fit=crop&crop=center"
