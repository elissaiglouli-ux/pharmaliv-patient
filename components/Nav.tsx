      ...
      <div style={{ width:'100%', maxWidth:1320, margin:'0 auto', padding:'0 28px', display:'flex', alignItems:'center' }}>
        ...
        <Link href="/" style={{ display:'flex', alignItems:'center', gap:10, textDecoration:'none' }}>
          ...
          <div>
            ...
            <div style={{ fontSize:10, color:'#8AABAB', marginTop:1 }}>Votre pharmacie, livrée.</div>
          </div>
        </Link>
        ...
        <div style={{ display:'flex', alignItems:'center', gap:24, marginLeft:32, flex:1 }}>
          {liens.map(l => (
            <Link key={l.href} href={l.href} style={{ fontSize:14, fontWeight: path===l.href ? 700 : 500, color: path===l.href ? '#1B8C8C' : '#3D5A5A', textDecoration:'none', borderBottom: path===l.href ? '2px solid #1B8C8C' : '2px solid transparent', paddingBottom:2, transition:'all 0.2s' }}>
              {l.label}
            </Link>
          ))}
        </div>
        ...
        <div style={{ display:'flex', alignItems:'center', gap:10 }}>
          ...
          {/* Panier */}
          <Link href="/panier" style={{ position:'relative', width:40, height:40, border:'1.5px solid rgba(27,140,140,0.2)', borderRadius:10, display:'flex', alignItems:'center', justifyContent:'center', textDecoration:'none', transition:'all 0.2s', background: path==='/panier' ? '#EAF7F7' : 'white' }}
            onMouseEnter={e => (e.currentTarget.style.borderColor='#1B8C8C')}
            onMouseLeave={e => (e.currentTarget.style.borderColor='rgba(27,140,140,0.2)')}>
          ...
          {/* Mon compte */}
          <Link href="/ordonnance" style={{ display:'flex', alignItems:'center', gap:6, background:'#1B8C8C', color:'white', padding:'9px 18px', borderRadius:10, fontSize:13, fontWeight:600, textDecoration:'none', transition:'background 0.2s' }}
            onMouseEnter={e => (e.currentTarget.style.background='#146E6E')}
            onMouseLeave={e => (e.currentTarget.style.background='#1B8C8C')}>
